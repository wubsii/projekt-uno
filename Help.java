...
public class Help {
    ...
    public static void showRulesInFile() {
        String rules = """
                ...
                Der erste Spieler, der alle Karten loswird, gewinnt die Runde.
                ...
                Das Spiel endet, sobald ein Spieler mindestens 500 Punte hat.
        ...
        try {
            ...
            System.out.println("Hilfe wird geöffnet...");

            ProcessBuilder processBuilder;
            if (System.getProperty("os.name").toLowerCase().contains("win")) {
                processBuilder = new ProcessBuilder("notepad", "uno_rules.txt");
            } else if (System.getProperty("os.name").toLowerCase().contains("mac")) {
                processBuilder = new ProcessBuilder("open", "uno_rules.txt");
            } else {
                processBuilder = new ProcessBuilder("xdg-open", "uno_rules.txt");
            }
            processBuilder.start();

        } catch (IOException e) {
            System.err.println("Hilfe konnte nicht geöffnet werden: " + e.getMessage());
        }
    }
}
